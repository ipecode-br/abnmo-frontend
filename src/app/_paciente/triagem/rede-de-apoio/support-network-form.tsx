...
import { ScreeningSupportNetworkCards } from '@/app/_paciente/triagem/rede-de-apoio/support-network-cards'
...
export function ScreeningSupportNetworkForm() {
  ...
  const { getStoredFormData, finishScreening } = useScreening({
    storageKey: PATIENT_STORAGE_KEYS.screening.supportNetwork,
  })
  ...
  async function handleAddContact(data: ScreeningSupportNetworkFormSchema) {
    ...
    setStorageItem(
      PATIENT_STORAGE_KEYS.screening.supportNetwork,
      updatedContacts,
    )
